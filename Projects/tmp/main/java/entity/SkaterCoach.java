...
public class SkaterCoach {
    ...
    @ManyToOne
    @JoinColumn(name = "id_coach", referencedColumnName = "id_coach", nullable = false)
    public Coach getCoachByIdCoach() {
        return coachByIdCoach;
    }

    public void setCoachByIdCoach(Coach coachByIdCoach) {
        this.coachByIdCoach = coachByIdCoach;
    }
